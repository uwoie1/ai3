...
CONTENT_BY_LABEL: dict[str, dict[str, list[str]]] = {
    ...
    labels[0]:{"texts":["중국식 냉면 입니다"],
              ...
              "images":["https://www.unileverfoodsolutions.co.kr/dam/global-ufs/mcos/south-korea/calcmenu/recipes/kr-recipes/chinese/header/%EC%A4%91%EA%B5%AD%EB%83%89%EB%A9%B4-chinese-cold-noodles-header-1260x709px.jpg"]},
    labels[1]:{"texts":["짜장면 입니다"],
              "videos":["https://www.youtube.com/watch?v=tQUTkWfHdO8"],
              "images":["https://m.health.chosun.com/site/data/img_dir/2024/08/02/2024080201848_0.jpg"]},
